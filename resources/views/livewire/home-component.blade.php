 ...
 <div class="container">
  <div class="row">
   <div class="middle_1 clearfix">
    ...
    <div class="col-sm-4">
	 <div class="middle_3">
	  <h3><a href="#">COMMERCIAL</a> DESIGN</h3>
	  ...
	  the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only.</p>
	  <a href="#"><img src="{{ asset('assets/images/off1.jpg') }}" alt="abc" height="300" class="img_responsive"></a>
	 </div>
	</div>
	<div class="col-sm-4">
	 <div class="middle_3">
	  <h3><a href="#">OFFICE </a> DESIGN</h3>
	  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since 
	  the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only.</p>
	  <a href="#"><img src="{{ asset('assets/images/off2.jpg') }}" alt="abc" height="300" class="img_responsive"></a>
	 </div>
	</div>
	<div class="col-sm-4">
	 <div class="middle_3">
	  <h3><a href="#">RESIDENTIAL</a> DESIGN</h3>
	  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since 
	  the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only.</p>
	  <a href="#"><img src="{{ asset('assets/images/off3.jpg') }}" alt="abc" height="300" class="img_responsive"></a>
	 </div>
	</div>
   </div>
  </div>
        ...
        <div class="col-sm-3">
		 <div class="explore_1">
		  <div class="ih-item square colored effect14 bottom_to_top"><a href="#">
                      <div class="img"><img src="{{ asset('assets/images/photo/img1.jpg') }}" height="50" alt="img"></div>
                      <div class="info">
                        <h3>Heading here</h3>
 ...
 <div class="container">
  <div class="row">
   <div class="col-sm-12">
	...
	<div class="col-sm-4">
	 <div class="product_2">
	  <p><a href="#"><img src="{{ asset('assets/images/photo/img1 (38).jpg') }}" height="250" alt="abc" class="img_responsive"></a></p>
	 </div>
	 <div class="product_3">
	  <h2>Mr Fred</h2>
	...
	<div class="col-sm-4">
	 <div class="product_2">
	  <p><a href="#"><img src="{{ asset('assets/images/photo/img1 (39).jpg') }}" height="250" alt="abc" class="img_responsive"></a></p>
	 </div>
	 <div class="product_3">
	  <h2>Mr Collins</h2>
	  <h4>Epoxy Engineer</h4>
	  <p>Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu eget nulla.torquent conubia.</p>
	  <ul>
	      <li><a href="#"><i class="fa fa-facebook"></i></a></li>
		  <li><a href="#"><i class="fa fa-twitter"></i></a></li>
	...
	<div class="col-sm-4">
	 <div class="product_2">
	  <p><a href="#"><img src="{{ asset('assets/images/photo/img1 (40).jpg') }}" height="250" alt="abc" class="img_responsive"></a></p>
	 </div>
	 <div class="product_3">
	  <h2>Mr Arnold</h2>
	  <h4>Marketer</h4>
 ...
 <div class="container">
  <div class="row">
   <div class="news_1 clearfix">
    ...
    <div class="col-sm-6">
	 <div class="news_3">
	  <a href="#"><img src="{{ asset('assets/images/event1.jpg') }}" height="250" alt="abc" class="img_responsive"></a>
	 </div>
